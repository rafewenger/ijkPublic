...
# define _MESH2D_TRIANGULATION_BASE_T_NAME_                           \
  ...
  template _MESH2D_TRIANGULATION_BASE_T_PARAM_
  template <typename ITYPE2, typename ITYPE3, int BIT_SIZE_TYPE_X>
  ...
  (const ITYPE2 ipoly, 
   ...
   std::vector<ITYPE3> & duplicate_triangle_list)
  {
    ...
    this->DoesTriangulationCreateDuplicateTriangles
      (ipoly, tri_list, duplicate_triangle_list);
